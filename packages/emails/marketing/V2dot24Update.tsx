    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={featureSection}>
          ...
          <Text style={text}>
            使用全新的 Anthropic 和 OpenRouter 区块，以 AI
            驱动的回复来增强您的聊天机器人。
            <br />
            <br />
            ...
            <br />
            <br />
            借助 Anthropic，您可以使用最新、最具突破性的 Claude AI
            模型生成回复。
          </Text>
          <Img
        ...
        <Section style={featureSection}>
          <Heading style={heading}>跨会话保持聊天状态</Heading>
          <Text style={text}>
            现在，如果您启用"记住用户"选项，当用户再次回到 typebot
            时，它将显示之前的聊天状态。
            <br />
            <br />
        ...
        <Section style={featureSection}>
          <Heading style={heading}>AI 生成区块的"转为"选项</Heading>
          <Text style={text}>
            通过 AI 生成区块上的全新"转为"选项，轻松切换不同的 AI
            服务。这一便捷功能使您能够尝试各种 AI
            模型，并为您的聊天机器人选择最合适的方案。
          </Text>
          <Img
        ...
        <Section style={featureSection}>
          <Heading style={heading}>错误修复与稳定性改进</Heading>
          <Text style={text}>
            我们都讨厌错误，对吧？本月我决定修复几乎所有已知问题和已报告的错误，让
            Typebot 更加可靠。
            <br />
            <br />
            从现在开始，我会始终重点修复新报告的错误。这正是我想要为 Typebot
            设定的标准。
            <br />
            <br />
            查看完整更新日志{" "}
