...
const tabs = [
  ...
  { key: "support", label: "智能客服", image: "/images/VvXricTVwTAJeng6.png" },
  {
    key: "recommend",
    label: "产品推荐",
    image: "/images/huix7Mj53zn9Elki.png",
  },
...
export function EditorPreview() {
  ...
  return (
    <section
      id="editor-preview"
      className="py-20 md:py-28 bg-linear-to-b from-white to-slate-50"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className="mt-8 relative rounded-3xl border-2 border-dashed border-slate-200 bg-slate-50/50 overflow-hidden aspect-[2502/1285]"
