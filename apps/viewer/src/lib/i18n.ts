...
const dict = {
  zh: {
    "rootPage.welcomeHeading": "欢迎使用 Typebot",
    "rootPage.intro":
      "Typebot 是一个无代码平台，让您能够轻松创建高级聊天机器人，并将其集成到网站以及 WhatsApp 等聊天平台中。",
    "rootPage.goToDashboard": "前往控制台",
    "errorPage.viewerUrlMissing": "缺少 NEXT_PUBLIC_VIEWER_URL",
    "errorPage.configureHint": "请确保正确配置了该应用（",
    "errorPage.configureHint.documentation": "https://docs.typebot.com/self-hosting/configuration",
    "errorPage.configureHint.closing": "）",
    "notFoundPage.title": "您要查找的机器人不存在",
  },
  en: {
    "rootPage.welcomeHeading": "Welcome to Typebot",
    "rootPage.intro":
    ...
    "errorPage.configureHint.documentation":
